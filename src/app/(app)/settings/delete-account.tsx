 ...
 * Account deletion.
 *
 * Deletion is reauthenticated, confirmed by typing a word, and reports its real
 * status. If the job fails the account stays usable and the user can retry or
 * cancel — the previous implementation deleted the Clerk identity first, which
 * locked people out of data that was never removed.
 */
function ConfiguredDeleteAccount() {
  ...
  // Clerk requires a fresh factor before a destructive account operation.
